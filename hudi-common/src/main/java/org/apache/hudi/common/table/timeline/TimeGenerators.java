...
public class TimeGenerators {
  ...
  public static TimeGenerator getTimeGenerator(HoodieTimeGeneratorConfig timeGeneratorConfig,
    ...
    return getTimeGenerator(timeGeneratorConfig, storageConf, null);
  }
  ...
  public static TimeGenerator getTimeGenerator(HoodieTimeGeneratorConfig timeGeneratorConfig,
    ...
    if (timeGeneratorConfig.canReuseTimeGenerator()) {
      return TIME_GENERATOR_CACHE.get(timeGeneratorConfig.getBasePath(), s -> getNewTimeGenerator(timeGeneratorConfig, storageConf, lockProvider));
    } else {
      return getNewTimeGenerator(timeGeneratorConfig, storageConf, lockProvider);
    }
  }
  ...
  private static TimeGenerator getNewTimeGenerator(HoodieTimeGeneratorConfig timeGeneratorConfig,
    ...
    if (Objects.requireNonNull(type) == TimeGeneratorType.WAIT_TO_ADJUST_SKEW) {
      return new SkewAdjustingTimeGenerator(timeGeneratorConfig, storageConf, lockProvider);
    }
