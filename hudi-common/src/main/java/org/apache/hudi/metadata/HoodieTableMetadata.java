...
public interface HoodieTableMetadata extends Serializable, AutoCloseable {
   ...
   */
  TmpFileWrapper[] getAllFilesInPartition(Path partitionPath) throws IOException;
   ...
   */
  Map<String, TmpFileWrapper[]> getAllFilesInPartitions(Collection<String> partitionPaths) throws IOException;
